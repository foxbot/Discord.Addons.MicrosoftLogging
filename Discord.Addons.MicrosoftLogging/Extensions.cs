...
namespace Discord.Addons.MicrosoftLogging
{
    public static class Extensions
    {
        ...
        public static void UseMicrosoftLogging(this BaseSocketClient client, ILogger logger, Func<LogMessage, Exception, string> formatter = null)
        {
